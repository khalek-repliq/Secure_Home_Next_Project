...
const HomeBanner = () => {
  return (
    <div className="relative w-full h-[calc(100vh-200px)] md:h-full mb-3">
      ...
      <div className="absolute px-3 md:px-5 lg:px-10 flex items-center w-full top-0 text-white bg-black h-full bg-opacity-20">
        <div className="flex flex-col space-y-3 md:space-y-5 w-full md:w-1/2">
          {/* Main title */}
          <h1 className="font-bold text-white text-3xl lg:text-6xl 2xl:text-8xl text-left lg:text-left">
